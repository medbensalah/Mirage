...
namespace Mirage
{
    ...
    {        
        ...
        namespace Draw
        {
            ...
            void Circle(const Mat4& transform, CircleRendererComponent& circle, int entityID = -1);
            void Circle(const Mat4& transform, const Vec4& color, float thickness, float fade, int entityID = -1);
            void Sprite(const Mat4& transform, SpriteRendererComponent& sprite, int entityID = -1);
            void Line(const Vec3& p0, const Vec3& p1, const Vec4& color, int entityID = -1);
            void Rect(const Vec3& position, const Vec2& size, const Vec4& color, int entityID = -1);
            void Rect(const Mat4& transform, const Vec4& color, int entityID = -1);
