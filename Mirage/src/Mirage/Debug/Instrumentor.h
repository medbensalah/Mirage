...
#define MRG_PROFILER 1

#if MRG_PROFILER
#if defined(__GNUC__) || (defined(__MWERKS__) && (__MWERKS__ >= 0x3000)) || (defined(__ICC) && (__ICC >= 600)) || defined(__ghs__)
        #define MRG_FUNC_SIG __PRETTY_FUNCTION__
#elif defined(__DMC__) && (__DMC__ >= 0x810)
        #define MRG_FUNC_SIG __PRETTY_FUNCTION__
#elif defined(__FUNCSIG__)
        #define MRG_FUNC_SIG __FUNCSIG__
#elif (defined(__INTEL_COMPILER) && (__INTEL_COMPILER >= 600)) || (defined(__IBMCPP__) && (__IBMCPP__ >= 500))
        #define MRG_FUNC_SIG __FUNCTION__
...
#define MRG_PROFILE_SCOPE(name)                        ::Mirage::InstrumentationTimer timer##__LINE__(name)
