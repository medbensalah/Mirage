...
namespace Mirage::VisualComponents
{
	...
	{
	public:
		ImageButton(const ImTextureID& texID, ImVec2 size, ImVec2 uv0 = {0, 0}, ImVec2 uv1 = {1, 1}, int framePadding = -1, const ImVec4& bgCol = {0, 0, 0, 0}, const ImVec4& tintCol = {1, 1, 1, 1});
