...
IncludeDir["mono"] = "%{wks.location}/Mirage/vendor/mono/include"
...
IncludeDir["imgui_node_editor"] = "%{wks.location}/Mirage/vendor/imgui-node-editor"
...
LibraryDir["mono"] = "%{wks.location}/Mirage/vendor/mono/lib/%{cfg.buildcfg}"
